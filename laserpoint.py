...
class Gui1(Frame):
	...
	def __init__(self, parent):
  	...
  	def initUI(self):
		...
		idleButton = Button(self, text="Idle", command = self.idle)
		ledButton = Button(self, text="toggle red dot", command = self.ledtoggle)
		blacklightButton = Button(self, text="toggle blacklight", command = self.blacklighttoggle)
		AngleSlider = Scale(self, from_=1, to=180)
		setButton = Button(self, text="Set Step", command = set_step)
		setButton.pack(side="bottom")
		AngleSlider.pack(side = "bottom")
		ledButton.place(x = 150,y = 80)
		blacklightButton.place(x = 170,y = 80)
		quitButton.place(x=0, y=100)
		upButton.place(x=250/4, y=0)
		downButton.place(x = 250/4, y = 50)
		leftButton.place(x = 0, y = 25)
		rightButton.place(x = 250/2, y = 25)
		idleButton.place(x = 200, y = 75)
		label = Label(self, text="Step Angle: " + str(AngleSlider.get()))
		label.pack(side="bottom")
		
	def ledtoggle(self):
		ser.write("led")
	def blacklighttoggle(self):
